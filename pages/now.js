  ...
  return (
    <div className="relative bg-zinc-900 px-4 pb-20 lg:px-8 lg:pt-10 lg:pb-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="ml-4 mt-10 flex justify-center">
        ...
        <div className="block m-4 text-center">
          <h1 className="mt-2 flex text-4xl font-black tracking-tighter text-gray-200 justify-center">Tom Cav</h1>
          <div class="mt-4 ml-1 flex justify-center space-x-2 text-gray-700">
      ...
      <div className='mt-10 m-10 md:mr-50 md:ml-50 lg:mr-72 lg:ml-72'>
        <h3 className='text-white font-bold'>What am I up to now?</h3>

        <p className='mt-4 text-gray-400'>► Co-founder & host for&nbsp;
          <Link href="https://linktr.ee/dragonsegg" className='underline'>Dragon's Egg Podcast</Link> with The&nbsp; 
          <Link href="https://drexel.edu/close/" className='underline'>Close School</Link> of Entreprenuership at Drexel University</p>
        <p className='mt-6 text-gray-400'>► Accepted a co-op as a Video Production Specialist for Drexel University<Link href="https://www.dannybennettproductions.com/" className='underline'></Link></p>
        <p className='mt-6 text-gray-400'>► Videographer for <Link href="https://linktr.ee/ladcast" className='underline'>Ladcast</Link></p>
        <p className='mt-6 text-gray-400'>► Wedding Videographer for <Link href="https://www.dannybennettproductions.com/" className='underline'>Danny Bennett Productions</Link></p>        </div>
    </div>
  )
}
