...
export default function Introduction() {
  return (
    <div className="md:fixed lg:fixed justify-center md:text-left lg:text-left md:justify-left lg:justify-left grid grid-cols-1 mb-10">
      <div className="ml-4 mt-10 flex justify-center md:justify-left lg:justify-left">
        <Image src="/imgs/tomCav.jpg" width={100} height={100} className="rounded-full w-40 h-40 text-center"/>
      </div>  
      <div className="block m-4">
        <h1 className="mt-2 flex text-5xl font-black tracking-tighter text-gray-200 text-center sm:text-center md:text-left lg:text-left">Tom Cav</h1>
        <div class="mt-4 ml-1 flex justify-center  md:justify-left lg:justify-left space-x-2 text-gray-700">
        ...
        <div className="mt-10 md:mb-10 md:mt-10 lg:mb-10 lg:mt-10 text-center lex md:justify-left lg:justify-left">
          <div className="text-center md:text-left lg:text-left w-100">
          ...
          <div className="flex text-center justify-center sm:justify-left md:justify-left">    
            <Link href="mailto:tpc75@drexel.edu">
              <div className="block border-2 rounded-lg border-white p-2 w-24 mt-10 bg-zinc-800 text-white">Email</div>
            </Link>
          </div>
      </div>
    </div>
